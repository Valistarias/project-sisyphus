...
const SkillBranchModel = (): Model<ISkillBranch<ObjectId>> =>
  model('SkillBranch', skillBranchSchema);

export { SkillBranchModel, type HydratedISkillBranch, type ISkillBranch, type LeanISkillBranch };
